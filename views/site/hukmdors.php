...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url('<?=Yii::$app->homeUrl?>theme/images/temur2.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row slider-text align-items-center">
                <div class="col-md-7 col-sm-12 ftco-animate">
                    <p class="breadcrumbs"><span class="mr-2"><a href="<?=Yii::$app->homeUrl?>"><?=getl('Bosh sahifa')?></a></span> <span><?=getl('Hukmdorlar')?></span></p>
                    <h1 class="mb-3"><?=getl('Tarixiy hukmdorlar')?></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 sidebar">
                ...
                <div class="sidebar-box ftco-animate">
                    <h3><?=getl('Tarixiy hukmdorlar')?></h3>
                    <p>
                        <?=getl('O\'zbekistonda yashab o\'tgan hukmdorlar - o\'zlarining adolatli davlat boshqaruvlari, keng miqiyosdagi yutuqlari bilan butun dunyoda dovrug\' qozonganlar.')?>
                    </p>
                </div>
            </div>
        </div>
