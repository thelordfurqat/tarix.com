...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url('<?=Yii::$app->homeUrl?>theme/images/ali.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row slider-text align-items-center">
                <div class="col-md-7 col-sm-12 ftco-animate">
                    <p class="breadcrumbs"><span class="mr-2"><a href="<?=Yii::$app->homeUrl?>"><?=getl('Bosh sahifa')?></a></span> <span><?=getl('Buyuk shaxslar')?></span></p>
                    <h1 class="mb-3"><?=getl('Tarixiy buyuk shaxslar')?></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 sidebar">
                ...
                <div class="sidebar-box ftco-animate">
                    <h3><?=getl('Tarixiy buyuk shaxslar')?></h3>
                    <p><?=getl('Bu insonlar - O\'zbekistonda yashab ijod qilgan, vatanni qadrlash, uning uchun xizmat qilish kerakligini amalda ko\'rsatib bergan hamda ilm - fan rivojiga ulkat xissalarni qo\'shgan insonlardir.')?>
